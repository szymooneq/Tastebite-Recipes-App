...
export default function Searchbar() {
  ...
  return (
    <div className="relative w-80">
      ...
      <Link
        to={`szukaj/${term}`}
        className="px-4 py-2 absolute right-2.5 bottom-2.5 rounded-lg text-sm font-medium focus:ring-4 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Szukaj</Link>
    </div>
  );
}
