  ...
  return (
    <div className="m-3 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        ...
        <p className="my-3 font-normal text-gray-700 dark:text-gray-400">{description}</p>
        <div className="flex items-center mb-3">
          {star}
          <p className="ml-2 text-sm font-bold text-gray-700 dark:text-white">{props.rating ?? 0}</p>
        </div>
        <Link 
          to={`/hotele/${props.id}`} 
