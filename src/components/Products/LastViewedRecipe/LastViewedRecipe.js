...
export default function LastViewedRecipe(props) {
  return (
    <div className="m-1 p-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      <div className="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Ostatnio oglądałeś ten przepis. Wciąż zainteresowany?</div>
